...
public class BSTMap<K extends Comparable<K>, V> implements Map61B<K, V> {
   ...
   /* return a tree removes the samllest key */
    private Node removeMin(K key, Node p) {
        if (p.left == null) {
            return p.right; // since in this case we removed p
        }
    ...
    /* return the tree which with desired item being removed */
